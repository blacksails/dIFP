...
Example test_minus: (minus 6 3) = 3.
Proof. reflexivity. Qed.

Example test2_minus: (minus (S (S O)) (S O)) = (S O).
Proof. reflexivity. Qed.
...
Definition eqb (b1:bool) (b2:bool) : bool :=
  match b1 with
  | true => andb b1 b2
  | false => andb (negb b1) (negb b2)
end.
Example test1_eqb: (eqb true true) = true.
Proof. reflexivity. Qed.
Example test2_eqb: (eqb false false) = true.
Proof. reflexivity. Qed.
Example test3_eqb: (eqb true false) = false.
Proof. reflexivity. Qed.
Example test4_eqb: (eqb false true) = false.
Proof. reflexivity. Qed.
